...
results_dir = os.path.join('Classification_Results', model_name + '_results_' + str(180) + '_epochs')
...
data_loader = data_utils(batch_size=batch_size,train_size=0.75,num_workers=num_workers,num_classes_sampler=2,num_samples=16,balanced_batches=True)

# dataloaders, dataset_sizes, class_names = data_loader.load_classification_data(data_dir, split_list)

dataloaders, dataset_sizes, attribute_mapper = data_loader.load_attribute_classification_data(image_folder ='/home/n-lab/Documents/Periocular_project/Datasets/ubipr/Class_Folders_Left_Images_Split',output_folder='/home/n-lab/Documents/Periocular_Project_GitHub',attribute_data_csv_loc='attribute_data.csv')
...
classes = data_dict['gender_label']
# Make a grid from batch
out = torchvision.utils.make_grid(data_dict['img'])
...
if classification:
    ...
    model = attribute_model(load_model_fname='/home/n-lab/Documents/Periocular_Project_GitHub/vgg_results_70epochs/epoch_68.pth', model_name=model_name,num_classes_classification=attribute_mapper.num_class_names,use_pretrained=True,head_config=data['head_configs'][0])
...
visualize_model(model, device, dataloaders, attribute_mapper.gender_labels, num_images=6)
print(train_metrics)
print(val_metrics)
